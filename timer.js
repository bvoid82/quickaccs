...
! function(t, e) {
            ...
            return n(a, [{
                ...
                value: function(t) {
                    ...
                    if (0 === t && (t = this.defaultRate), t && (t !== this.rate || e) && t > 0 && (this.rate = t, this.onRateChanged(t)), null == t) {
                        var n = prompt("Enter the timer change multiplier you want to change（Current：" + this.rate + "）");
                ...
                key: "speedDown",
                value: function(t) {
                    null == t && (t = this.getConfig("decrementRate")), this.setSpeed(this.rate - t)
                }
            }, {
                key: "speedUp",
                value: function(t) {
                    null == t && (t = this.getConfig("incrementRate")), this.setSpeed(this.rate + t)
                }
            }, {
                key: "speedDivide",
                value: function(t) {
                    null == t && (t = this.getConfig("divideRate")), this.setSpeed(this.rate / (t || 1))
                }
            }, {
                key: "speedMultiply",
                value: function(t) {
                    null == t && (t = this.getConfig("multiplyRate")), this.setSpeed(this.rate * (t || 1))
                }
            }, {
                key: "onRateChanged",
                value: function(t) {
        ...
        return n(i, [{
            ...
            value: function() {
                return [{
                    ...
                    default: ["ctrl + Equal", "meta + Equal", "ctrl + Period", "meta + Period"]
                }, {
                    type: f.ARRAY,
                    itemType: f.SHORTCUT,
                    key: "shortcutExpressions.-",
                    default: ["ctrl + Minus", "meta + Minus", "ctrl + Comma", "meta + Comma"]
                }, {
                    type: f.ARRAY,
                    itemType: f.SHORTCUT,
                    key: "shortcutExpressions.*",
        ...
        return n(i, [{
            ...
            value: function() {
                ...
                t ? t.applyDefineRole((function(t) {
                    if (t.target instanceof HTMLVideoElement && "playbackRate" === t.key) return P("Locking of the video magnification of the site has been blocked"), !0
    ...
    var Jt = function(e) {
            ...
            return n(i, [{
                ...
                value: function() {
                    var t = this;
                    B(c(i.prototype), "init", this).call(this), "function" == typeof j.registerMenuCommand && (j.registerMenuCommand("主页", (function() {
                        t.openPage("https://timer.palerock.cn")
                    })), j.registerMenuCommand("Open the configuration page", (function() {
    ...
    var Zt = function(e) {
        ...
        te = new F;
    return te.exportOuter(), te.registerModule(new Jt(new Qt)), te.registerModule(new Ht), te.registerModule(new Ft), te.registerModule(new It), te.registerModule(new Et), te.registerModule(new $t), te.registerModule(new Nt, !0), te.registerModule(new Zt, !0), te.bootstrap(), te
}));
